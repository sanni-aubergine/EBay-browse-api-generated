...
part of 'item_location_impl.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ItemLocationImpl> _$itemLocationImplSerializer =
    new _$ItemLocationImplSerializer();

class _$ItemLocationImplSerializer
    implements StructuredSerializer<ItemLocationImpl> {
  @override
  final Iterable<Type> types = const [ItemLocationImpl, _$ItemLocationImpl];
  @override
  final String wireName = 'ItemLocationImpl';

  @override
  Iterable<Object> serialize(Serializers serializers, ItemLocationImpl object,
  ...
  @override
  ItemLocationImpl deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ItemLocationImplBuilder();
...
class _$ItemLocationImpl extends ItemLocationImpl {
  @override
  ...
  factory _$ItemLocationImpl(
          [void Function(ItemLocationImplBuilder) updates]) =>
      (new ItemLocationImplBuilder()..update(updates)).build();

  _$ItemLocationImpl._(
      {this.addressLine1,
      this.addressLine2,
      this.city,
      this.country,
  ...
  @override
  ItemLocationImpl rebuild(void Function(ItemLocationImplBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ItemLocationImplBuilder toBuilder() =>
      new ItemLocationImplBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ItemLocationImpl &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ItemLocationImpl')
...
class ItemLocationImplBuilder
    implements Builder<ItemLocationImpl, ItemLocationImplBuilder> {
  _$ItemLocationImpl _$v;
  ...
  ItemLocationImplBuilder();

  ItemLocationImplBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(ItemLocationImpl other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ItemLocationImpl;
  }

  @override
  void update(void Function(ItemLocationImplBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$ItemLocationImpl build() {
    final _$result = _$v ??
        new _$ItemLocationImpl._(
