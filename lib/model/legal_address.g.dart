...
part of 'legal_address.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<LegalAddress> _$legalAddressSerializer =
    new _$LegalAddressSerializer();

class _$LegalAddressSerializer implements StructuredSerializer<LegalAddress> {
  @override
  final Iterable<Type> types = const [LegalAddress, _$LegalAddress];
  @override
  final String wireName = 'LegalAddress';

  @override
  Iterable<Object> serialize(Serializers serializers, LegalAddress object,
  ...
  @override
  LegalAddress deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new LegalAddressBuilder();
...
class _$LegalAddress extends LegalAddress {
  @override
  ...
  factory _$LegalAddress([void Function(LegalAddressBuilder) updates]) =>
      (new LegalAddressBuilder()..update(updates)).build();
  ...
  @override
  LegalAddress rebuild(void Function(LegalAddressBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LegalAddressBuilder toBuilder() => new LegalAddressBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LegalAddress &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('LegalAddress')
...
class LegalAddressBuilder
    implements Builder<LegalAddress, LegalAddressBuilder> {
  _$LegalAddress _$v;
  ...
  LegalAddressBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(LegalAddress other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$LegalAddress;
  }

  @override
  void update(void Function(LegalAddressBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$LegalAddress build() {
    final _$result = _$v ??
        new _$LegalAddress._(
